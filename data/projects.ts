  ...
  // for the four that appear on the homepage Branding section.
  {
    ...
    gallery: {
      ...
      images: [
        ...
        { label: "Signage & menu", aspect: "tall" },
        { label: "Social presence", aspect: "wide" },
      ],
    },
  },
  {
    ...
    gallery: {
      ...
      images: [
        ...
        { label: "Wayfinding & keys", aspect: "tall" },
        { label: "Website concept", aspect: "wide" },
      ],
    },
  },
  {
    ...
    gallery: {
      ...
      images: [
        ...
        { label: "Label details", aspect: "tall" },
        { label: "Merch & launch set", aspect: "wide" },
      ],
    },
  },
  {
    ...
    gallery: {
      ...
      images: [
        ...
        { label: "Space & signage cues", aspect: "tall" },
        { label: "Website & booking concept", aspect: "wide" },
      ],
    },
  },
  {
    ...
    gallery: {
      ...
      images: [
        ...
        { label: "Clinic signage", aspect: "tall" },
        { label: "Website concept", aspect: "wide" },
      ],
    },
  },
  {
    ...
    gallery: {
      ...
      images: [
        ...
        { label: "Studio environment", aspect: "tall" },
        { label: "Social content system", aspect: "wide" },
      ],
    },
  },
