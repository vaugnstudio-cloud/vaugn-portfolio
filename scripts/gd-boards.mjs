...
//   node scripts/gd-boards.mjs
import { chromium } from "playwright";

const OUT = "public/images/gd";
const FONTS =
  "https://fonts.googleapis.com/css2?family=Fraunces:ital,wght@0,400..700;1,400..600&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&family=Archivo+Black&family=Marcellus&display=swap";
const noise = (o = 0.05) =>
...
const boards = {
  ...
  "hosp-menu-drop": [1600, 1000, shell(1600, 1000, `background:#2A1E17;background-image:${noise(0.07)};padding:64px;display:flex;gap:54px;color:#F3E9DC;`, `
    ...
    <div style="flex:1;display:grid;grid-template-rows:1fr 1fr;gap:22px;">
      <div style="border-radius:16px;background:repeating-linear-gradient(45deg,#3A2A1E,#3A2A1E 14px,#33241A 14px,#33241A 28px);display:flex;align-items:center;justify-content:center;"><p class="mono" style="font-size:12px;opacity:.55;">HERO DISH PHOTO</p></div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:22px;">
        <div style="border-radius:16px;background:#E8A13C;color:#2A1E17;padding:24px;display:flex;flex-direction:column;"><p style="font-family:'Fraunces';font-weight:600;font-size:30px;">$— dish name</p><p class="mono" style="margin-top:auto;font-size:10px;">FEED TILE</p></div>
        <div style="border-radius:16px;border:2px dashed #F3E9DC44;padding:24px;display:flex;flex-direction:column;"><p style="font-family:'Inter';font-weight:600;font-size:22px;">9:16 story crop</p><p class="mono" style="margin-top:auto;font-size:10px;opacity:.6;">STORY</p></div>
      </div>
    </div>`)],
  ...
  "hosp-special-story": [1200, 1500, shell(1200, 1500, `background:#F3E9DC;background-image:${noise(0.05)};padding:70px;display:flex;flex-direction:column;color:#2A1E17;`, `
    ...
    <div style="flex:1;border-radius:20px;background:repeating-linear-gradient(45deg,#E4D5C2,#E4D5C2 16px,#EADDCB 16px,#EADDCB 32px);margin-top:40px;display:flex;align-items:center;justify-content:center;"><p class="mono" style="font-size:13px;opacity:.5;">DISH PHOTO — FULL BLEED</p></div>
    <div style="display:flex;justify-content:space-between;align-items:baseline;margin-top:44px;">
      ...
      <p style="font-family:'Fraunces';font-style:italic;font-size:64px;color:#C4552D;">$—</p>
    </div>
    <p style="font-family:'Inter';font-size:26px;opacity:.7;margin-top:16px;">One line of appetite copy — short enough to read mid-scroll.</p>`)],
